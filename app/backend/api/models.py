...
class Trip(models.Model):
    ...
    cycle_hours_used: models.DecimalField[Decimal, Decimal] = models.DecimalField(max_digits=10, decimal_places=2)
    start_time: models.DateTimeField[str, str] = models.DateTimeField()
    total_miles: models.DecimalField[Decimal | None, Decimal | None] = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    total_duration_hrs: models.DecimalField[Decimal | None, Decimal | None] = models.DecimalField(max_digits=10, decimal_places=2, null=True)
...
class TripSegment(models.Model):
    ...
    trip: models.ForeignKey[Trip, Trip] = models.ForeignKey(Trip, on_delete=models.CASCADE, related_name="segments")
    status: models.CharField[str, str] = models.CharField(max_length=24, choices=DutyStatus.choices)
    start_time: models.DateTimeField[str, str] = models.DateTimeField()
    end_time: models.DateTimeField[str, str] = models.DateTimeField()
    duration_hrs: models.DecimalField[Decimal, Decimal] = models.DecimalField(max_digits=10, decimal_places=2)
...
class DailyLog(models.Model):
    ...
    trip: models.ForeignKey[Trip, Trip] = models.ForeignKey(Trip, on_delete=models.CASCADE, related_name="daily_logs")
    date: models.DateField[str, str] = models.DateField()
    total_off_duty: models.DecimalField[Decimal, Decimal] = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal("0"))
    total_sleeper: models.DecimalField[Decimal, Decimal] = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal("0"))
    total_driving: models.DecimalField[Decimal, Decimal] = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal("0"))
    total_on_duty_nd: models.DecimalField[Decimal, Decimal] = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal("0"))
